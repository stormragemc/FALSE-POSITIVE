"""Play David line 2 voice auditions. Reference only: David is normally the player."""
...
if __name__ == "__main__":
    play_candidates(
        __file__,
        "line-02-confession",
        "Nick and Ivy. They'd been seeing each other for two years. I knew, and I kept it from Aaron.",
        CANDIDATES,
    )
