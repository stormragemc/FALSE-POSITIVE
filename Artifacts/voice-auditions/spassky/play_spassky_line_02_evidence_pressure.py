"""Play Officer Spassky line 2 voice auditions."""
...
if __name__ == "__main__":
    play_candidates(
        ...
        "You were unconscious when someone turned that key. You can draw a conclusion, but you cannot say you saw it happen.",
        CANDIDATES,
    )
